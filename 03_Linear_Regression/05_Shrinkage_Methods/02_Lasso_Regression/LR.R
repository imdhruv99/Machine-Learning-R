# importing data
df <- read.csv("D:/Programming/Machine Learning/Machine Learning with Python and R/R/03_Linear_Regression/05_Shrinkage_Methods/02_Lasso_Regression/House_Price.csv",
               header = TRUE)
...
# running model
lr <- glmnet(x,y, alpha = 0, lambda = grid)
summary(rr)
...
y_predicted <- predict(lr, s = opt_lambda, newx = x)
